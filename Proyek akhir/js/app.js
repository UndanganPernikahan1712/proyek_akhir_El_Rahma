...
// Menampilkan nama di dalam elemen span dengan class 'pb-3 px-3'
const namaContainer = document.querySelector('.pb-3.px-3 span');
if (namaContainer) {
...
document.getElementById('whatsapp-button').addEventListener('click', function(event) {
    ...
    // Menentukan teks kehadiran
    var teksKehadiran = kehadiran === '1' ? 'Hadir' : kehadiran === '2' ? 'Berhalangan' : 'Konfirmasi Kehadiran';

    // Membuat pesan WhatsApp
    var whatsappMessage = `Nama: ${nama}\nKehadiran: ${teksKehadiran}\nUcapan & Doa: ${pesan}`;
    var whatsappUrl = `https://wa.me/+6285893526744?text=${encodeURIComponent(whatsappMessage)}`;
